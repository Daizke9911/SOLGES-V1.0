            ...
            <div class="bg-white rounded-xl shadow-2xl max-w-md w-full">
                <div class="p-6">
                    ...
                    <p class="text-gray-700 mb-6">
                        ¿Estás seguro de que deseas eliminar este cargo? Se perderán todos los datos asociados.
                    </p>
                    <p class="text-sm text-gray-400 mb-6">Cargo: {{ $deleteCargo->descripcion }}</p>
                    ...
                    <div class="flex justify-end space-x-4">
                        ...
                        <button wire:click="deleteCargoDefinitive" 
                ...
                <div class="">
                    <div class="flex max-lg:flex-col lg:items-center lg:justify-between mb-6">
                        ...
                        <div class="relative w-full sm:w-auto max-lg:mt-4">
                            <input type="text" wire:model.live.debounce.300ms="search" placeholder="Buscar cargo..."
                ...
                <div class="overflow-x-auto max-lg:pb-4">
                    <table class="w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($cargosRender as $cargoRender)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-bold">
                                        {{ $cargoRender->descripcion }}
                                    </td>
                                    <td class="px-2 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            <!-- View Button -->
                                            <button wire:click="viewCargo({{ $cargoRender->cargo_id }})" 
                                            ...
                                            <!-- Edit Button -->
                                            <button wire:click="editCargos({{ $cargoRender->cargo_id }})" 
                                            ...
                                            <!-- Delete Button -->
                                            <button wire:click="confirmDelete({{ $cargoRender->cargo_id }})"
                    ...
                    @if($cargosRender->isEmpty() && $cargosRender->currentPage() == 1)
                        <div class="text-center py-8">
                            <i class='bx bx-file text-4xl text-gray-400 mb-4'></i>
                            <h3 class="text-lg font-medium text-gray-900 mb-2">No hay cargos</h3>
                            <p class="text-gray-500">
                                No se encontraron registros de cargos en el sistema
                            </p>
                        </div>
                    @else
                        <div class="mx-5">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                                            <i class='bx {{ $editingCargo ? 'bx-edit' : 'bx-plus' }}  text-blue-600 text-xl'></i>
                                        </div>
                            ...
                            <div class="space-y-6">
                                <div class="bg-gray-50 rounded-lg p-6">
                                    <div class="flex items-center mb-4">
                                        ...
                                        <div>
                                            <h3 class="text-md lg:text-lg font-bold text-gray-900">Nombre del Cargo</h3>
                                        </div>
                                    </div>
                                    <input type="text" wire:model.live="cargo.descripcion" id="input-cargo-descripcion" maxlength="100"
                                    ...
                                    <div class="flex justify-between items-center mt-4">
                                        <div class="flex items-center text-sm text-gray-500">
                                            ...
                                            <span>Caracteres: {{ strlen($cargo['descripcion']) }}/100</span>
                                        </div>
                                        <div class="flex items-center">
                                            @if($cargo['descripcion'])
                                                @if(strlen($cargo['descripcion']) <= 100)
                            ...
                            {{--  BOTON CREATE/EDIT --}}
                                <div class="flex flex-col sm:flex-row items-center pt-8 border-t border-gray-200 space-y-4 sm:space-y-0 justify-between">
                                    ...
                                    <button type="submit" 
                                        ...
                                        <i class='bx {{ $editingCargo ? 'bx-save' : 'bx-check' }} mr-2'></i>
                                        {{ $editingCargo ? 'Actualizar Cargo' : 'Crear Cargo' }}
                                    </button>
                                </div>
                            </div>
                        </form>
                    ...
                    @if ($activeTab === 'show')
                        <div class="pb-2">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-4">
                                    <button wire:click="editCargos('{{$showCargo->cargo_id}}')" 
                                            class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-sm"
                                            title="Editar Cargo">
                                        <i class='bx bx-edit text-xl'></i>
                                    </button>
                                    <button wire:click="confirmDelete('{{$showCargo->cargo_id}}')" 
                            ...
                            <div class="flex flex-col gap-6">
                                <div>
                                    ...
                                    <div class="p-3 bg-gray-50 rounded-lg">
                                        <p class="text-gray-900 font-medium">{{ $showCargo->descripcion }}</p>
                                    </div>
                                </div>
                                <div class="flex grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <div class="p-3 bg-gray-50 rounded-lg">
                                            <p class="text-gray-900">{{ $showCargo->created_at->format('d/m/Y') }}</p>
                                        </div>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Fecha de Editada</label>
                                        <div class="p-3 bg-gray-50 rounded-lg">
                                            <p class="text-gray-900">{{ $showCargo->updated_at->format('d/m/Y') }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
